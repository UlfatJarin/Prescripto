...
const Contact = () => {
  return (
    <div>
      <div className='flex justify-center mt-16 mb-20'><h4 className='font-normal text-2xl text-text2 mb-7 '>CONTACT <span className='text-text1 font-semibold'>US</span></h4></div>
      <div className='grid grid-cols-2  gap-12'>
        <div className='flex justify-end'>
          <img className='max-w-[560px]' src={assets.contact_image} alt="" />
        </div>

        <div className='flex flex-col gap-5 text-lg text-text2 mt-12'>

    ...
    return (
        <div className='mt-16'>
            <div className='grid grid-cols-4 py-16 gap-5'>
                ...
                <div>
                    <h5 className='font-Outfit font-semibold text-[22px] leading-7 text-text2 mb-10' >COMPANY</h5>
                ...
                <div>
                    <h5 className='font-Outfit font-semibold text-[22px] leading-7 text-text2 mb-10'>GET IN TOUCH</h5>
                    <ul className='font-Outfit text-lg leading-7 text-text2 flex flex-col gap-2'>
